...
namespace MCEI.SysControlAdmin.DAL.ProfessionOrStudy___DAL
{
    public class ProfessionOrStudyDAL
    {
        ...
        public static async Task<int> CreateAsync(ProfessionOrStudy professionOrStudys)
        {
            ...
            using (var dbContext = new ContextDB())
            {
                ...
                {
                    dbContext.ProfessionOrStudy.Add(professionOrStudys);
        ...
        public static async Task<int> UpdateAsync(ProfessionOrStudy professionOrStudys)
        {
            ...
            using (var dbContext = new ContextDB())
            {
                ...
                var professionOrStudyDB = await dbContext.ProfessionOrStudy.FirstOrDefaultAsync(c => c.Id == professionOrStudys.Id);
        ...
        public static async Task<int> DeleteAsync(ProfessionOrStudy professionOrStudys)
        {
            ...
            using (var dbContext = new ContextDB())
            {
                ...
                if (professionOrStudyDB != null)
                {
                    dbContext.ProfessionOrStudy.Remove(professionOrStudyDB);
                    result = await dbContext.SaveChangesAsync();
                }
            }
            return result;  // Si se realizo con exito devuelve 1 sino devuelve 0
        ...
        public static async Task<List<ProfessionOrStudy>> GetAllAsync()
        {
            ...
            using (var dbContext = new ContextDB())
            {
                professionOrStudies = await dbContext.ProfessionOrStudy.ToListAsync();
            }
        ...
        public static async Task<ProfessionOrStudy> GetByIdAsync(ProfessionOrStudy professionOrStudys)
        {
            ...
            using (var dbContext = new ContextDB())
            {
                professionOrStudyDB = await dbContext.ProfessionOrStudy.FirstOrDefaultAsync(c => c.Id == professionOrStudys.Id);
            }
        ...
        public static async Task<List<ProfessionOrStudy>> SearchAsync(ProfessionOrStudy professionOrStudys)
        {
            ...
            using (var dbContext = new ContextDB())
            {
                var select = dbContext.ProfessionOrStudy.AsQueryable();
        ...
        private static async Task<bool> ExistProfessionOrStudy(ProfessionOrStudy professionOrStudy, ContextDB dbContext)
        {
            bool result = false;
            var professionOrStudys = await dbContext.ProfessionOrStudy.FirstOrDefaultAsync(p => p.Name == professionOrStudy.Name && p.Id != professionOrStudy.Id);
